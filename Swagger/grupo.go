...
type GetOneGrupoAdministradorAcademicoSwagger struct {
	Status bool                                               `json:"status"`
	Meta   string                                             `json:"meta"`
	Data   Response.GetOneGrupoAdministradorAcademicoResponse `json:"data"`
}

type GetGruposAdministradorAcademicoSwagger struct {
	Status bool                                             `json:"status"`
	Meta   string                                           `json:"meta"`
