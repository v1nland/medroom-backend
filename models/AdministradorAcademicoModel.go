...
type AdministradorAcademico struct {
	...
	Cursos_administrador_academico             []Curso   `json:"cursos_administradores_academico" gorm:"many2many:administradores_academicos_cursos;joinForeignKey:id_administrador_academico;joinReferences:sigla_curso,id_periodo"`
