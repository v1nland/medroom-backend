...
func GetEvaluacionesOutput(u []Models.Evaluacion) (output []Response.ListEvaluacionesResponse) {
	for i := 0; i < len(u); i++ {
...
func GetEvaluacionesEstudianteOutput(u []Models.Evaluacion) (output []Response.ListEvaluacionesEstudianteResponse) {
	for i := 0; i < len(u); i++ {
...
func GetOneEvaluacionOutput(u Models.Evaluacion) (output Response.GetOneEvaluacionResponse) {
...
func AddNewEvaluacionOutput(u Models.Evaluacion) (output Response.AddNewEvaluacionResponse) {
...
func GenerarEvaluacionOutput(u Models.Evaluacion) (output Response.GenerarEvaluacionResponse) {
...
func PutOneEvaluacionOutput(u Models.Evaluacion) (output Response.PutOneEvaluacionResponse) {
...
func DeleteEvaluacionOutput(u Models.Evaluacion) (output Response.DeleteEvaluacionResponse) {
