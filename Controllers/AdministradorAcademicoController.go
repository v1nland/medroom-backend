...
func AddNewAdministradorAcademico(c *gin.Context) {
	...
	Input.AddNewAdministradorAcademico(&input)
...
func PutOneAdministradorAcademico(c *gin.Context) {
	...
	Input.PutOneAdministradorAcademico(&input)
	...
	// output
	ApiHelpers.RespondJSON(c, 200, Output.PutOneAdministradorAcademicoOutput(administrador_academico))
}
...
func PutMyAdministradorAcademico(c *gin.Context) {
	...
	// format input
	Input.PutMyAdministradorAcademico(&input)
